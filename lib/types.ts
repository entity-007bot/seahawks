...
// Canonical, ordered, DE-DUPLICATED list for rendering rank selectors (dropdowns, radio groups).
// Do NOT use Object.values(MemberRank) for UI lists — it will include every
// legacy alias key above (QUARTERMASTER_GENERAL, CHIEF_BOATSWAIN, etc.),
// producing duplicate entries in the UI since many aliases share the same string value.
export const RANK_LIST: MemberRank[] = [
  MemberRank.LANDSMAN,
  MemberRank.SEAMAN,
  MemberRank.ABLE_SEAMAN,
  MemberRank.SALTED_SEAMAN,
  MemberRank.SEASONED_SEAMAN,
  MemberRank.WEATHERED_SEAMAN,
  MemberRank.ABLE_PRIVATEER,
  MemberRank.PRIVATEER,
  MemberRank.SENIOR_PRIVATEER,
  MemberRank.MASTER_PRIVATEER,
  MemberRank.LIEUTENANT_PRIVATEER,
  MemberRank.COMMANDER_PRIVATEER,
  MemberRank.CAPTAIN_PRIVATEER,
  MemberRank.COMMODORE_PRIVATEER,
  MemberRank.ADMIRAL_PRIVATEER,
];
...
export interface Application {
  ...
  // Legacy fields kept optional in case other components still reference them
